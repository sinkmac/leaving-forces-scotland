window.LFS_FACTS = {
  ...
  volatileFacts: [
    { id: 'housing-local-connection-script', risk: 'statutory-script', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'compensation-disregard-uc', risk: 'legal-benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'compensation-disregard-hb', risk: 'legal-benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'compensation-disregard-ctr-scotland', risk: 'legal-benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'afcs-time-limit', risk: 'legal-deadline', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'covenant-duty-2026', risk: 'statutory-duty', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'afps75-deferred-age', risk: 'pension', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'afps05-deferred-age', risk: 'pension', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'afps15-deferred-age', risk: 'pension', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'edp-18-under-55', risk: 'pension', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'gp-veterans-recognition', risk: 'health-route', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'valour-status-ssafa-round1', risk: 'scheme-status', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'visin-hosting-referral', risk: 'health-route', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'adp-replaced-pip', risk: 'benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'adp-transfer-handling', risk: 'benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'adp-components', risk: 'benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'adp-income-savings-work', risk: 'benefits', review_by: '2026-07-31', disposition: 'pending', register: 'content-citation-register.md' },
    { id: 'lgbt-financial-recognition-scheme', risk: 'scheme-status', review_by: '2026-08-31', disposition: 'pending', register: 'content-citation-register.md' }
  ],
  printStages: {
